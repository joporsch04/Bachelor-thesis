...
\begin{equation}
    \ket{\Psi(t)} = -\frac{i}{\hbar} \int_{t_0}^{t} \dd t' \bra{\Xi(t=t_c)} e^{-\frac{i}{\hbar} \int_{t'}^{t} \hat{\Hs}(t'') \dd t''}\hat{V}(t') e^{-\frac{i}{\hbar} \int_{t_0}^{t'} \hat{\Hs_0} \dd t''} \ket{\Psi(0)}
\end{equation}
...
\begin{equation*}
    \begin{aligned}
        ...
        \hat{\Hs}_F(t) &= \hat{\Hs}(t) - \hat{V}_C \\
        e^{-\frac{i}{\hbar} \int_{t'}^{t} \hat{\Hs}(t'') \dd t''} &\approx e^{-\frac{i}{\hbar} \int_{t'}^{t} \hat{\Hs}_F(t'') \dd t''}
    \end{aligned}
\end{equation*}
\begin{equation}
