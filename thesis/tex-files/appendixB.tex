...
Important: in atomic units is $E_m=\frac{Z^2}{2n^2}$\\
...
then its interesting to see the form of the fourier ztransform of eigenstate because same strcuture with spherical harmonics ust in momentum space now.\\
